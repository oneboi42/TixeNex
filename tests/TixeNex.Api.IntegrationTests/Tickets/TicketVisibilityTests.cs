...
{
    private const string JwtIssuer = "TixeNex.Tests";
    private const string JwtAudience = "TixeNex.Tests";
    private const string JwtKey = "TixeNex.Tests.Super.Secret.Key.For.Jwt.Token.Signing.123456789";
